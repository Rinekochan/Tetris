...
{
    public class BlitzExtraIngameDrawStrategy : IExtraIngameDrawStrategy // This class draws extra information of Blitz game mode in Ingame State
    {
        public void DrawExtra(GameModel gameModel)
        {
            // Draw button for extra informations in Blitz Game Mode
            ...
            SplashKit.DrawText("Time Left", Color.White, "Modern", 28, 340, 425);
            SplashKit.DrawText(TickTranslation.TickToString(120000 - gameModel.Game.CurrentTick.IngameTimer.Ticks), Color.White, "Modern", 32, 340, 450);
        }
